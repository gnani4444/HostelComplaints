...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-block">     
                                <div>
                                    <h2 class="card-title" style="color:rgb(252,75,108);">Features</h2>
                                    <h6 class="card-subtitle">features of Complaint System</h6> </div>
                                <div class="card-body">
                                    <ul>
                                    <li> Check Regular Notifications</li> 
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-block">     
                                <div>
                                    <h2 class="card-title" style="color:rgb(252,75,108);">Notifications</h2>
                                    <h6 class="card-subtitle">regular notifications</h6> </div>
                                <div class="card-body">
                                    <ul>
                                    <li>Coming Soon</li>
                                    </ul>
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer"> © 2017 Web Design Team </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
