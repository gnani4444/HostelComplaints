...
<script type="text/javascript">
    function call(argument) {
        window.open('view_complaints.php?q='+argument,'_self');
    }
</script>
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">View All Complaints</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-block">
                                <select name="type_of_complaints" class="form-control form-control-line" onchange="call(this.value)">
                ...
                <div class="row">
                    ...
                    if (isset($_GET['q']) && !empty($_GET['q'])) { 
                        ...
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">'.$value["filed_date"].'</h4>
                                ...
                                <div>
                                    ...
                                    echo '<p style="font-weight:bold">Submitted By: '.$submitted["name"].'</p><p>'.$submitted["email"].'  '.$submitted["phone_no"].' '.@$submitted["block"].' '.$submitted["room_no"].'</p>';
                                    echo '
                                </div>
                            </div>
                        </div>
